            ...
            <div className=" hidden  px-4 lg:flex  justify-between">
                <div className="w-full place-content-end flex">
                    <div className="w-1/2 bg-[#f0e9f8] flex justify-evenly !mt-5 !px-5 !py-3 rounded-[15px]" >
                        <h2 className="text-[#263030] hover:text-[#9F70FD] cursor-pointer capitalize font-sans text-[16px]">Home</h2>
                        <h2 className="text-[#263030] hover:text-[#9F70FD] cursor-pointer capitalize font-sans text-[16px]">About us</h2>
                        <h2 className="text-[#263030] hover:text-[#9F70FD] cursor-pointer capitalize font-sans text-[16px]">services</h2>
                        <h2 className="text-[#263030] hover:text-[#9F70FD] cursor-pointer capitalize font-sans text-[16px]">contact us</h2>
                    </div>
                </div>
                <div className="w-[40vw] place-content-end place-items-end flex !mr-5">
                    <div className="flex  cursor-pointer justify-center h-[80%] !px-5 !py-3 items-center bg-gradient-to-r from-[#E770C0] via-[#C670DE] to-[#9F70FD] w-[150px] rounded-[40px]">
                        <h1 className="text-[#fff] capitalize   font-sans text-[16px]">Get Started</h1>
                    </div>
                </div>
            </div>
            {/* Mobile Menu Button */}
